...
public class DefaultConnectorTypes {
     ...
     */
    public static final String TOP_BOTH = "top-both";
     ...
     */
    public static final String RIGHT_BOTH = "right-both";
     ...
     */
    public static final String BOTTOM_BOTH = "bottom-both";
     ...
     */
    public static final String LEFT_BOTH = "left-both";
    ...
    /**
     * Returns true if the type corresponds to an output or an input connector.
     *
     * @param type a connector's type string
     * @return {@code true} if the connector is any kind of output or input
     */
    public static boolean isBoth(final String type) {
        return type.contains(BOTH);
    }
