...
public class GraphEditorView extends Region {
    ...
    private static final String STYLESHEET_VIEW = "/de/tesis/dynaware/core/view/view.css";
    private static final String STYLESHEET_DEFAULTS = "/de/tesis/dynaware/core/view/defaults.css";
