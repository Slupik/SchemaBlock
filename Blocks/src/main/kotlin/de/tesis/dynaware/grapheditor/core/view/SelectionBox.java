...
public class SelectionBox extends Rectangle {
    ...
    /**
     * Adds a listener to the focused property of the selection box's window, so that the selection box always
     * disappears when the window loses focus.
     *
     * <p>
     * If this listener is not added, the selection box will not disappear if the user alt-tabs before releasing the
     * right-mouse button.
     * </p>
     */
